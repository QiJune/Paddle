import paddle.framework.proto.op_proto_pb2
import paddle.framework.proto.attr_type_pb2
import unittest


class TestFrameworkProto(unittest.TestCase):
    def test_all(self):
        op_proto_lib = paddle.framework.proto.op_proto_pb2
        attr_type_lib = paddle.framework.proto.attr_type_pb2
